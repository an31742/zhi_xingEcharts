          ...
          <div class="down-left-up">
            ...
            <div class="down-left-up-content">
              <div class="down-left-up-content-up">
                ...
                <!-- style="overflow-x:auto;width:342px" -->
                <div class="down-left-up-content-up-row">
                  <i></i>
                  <label>部门：</label>
              ...
              <div class="time-line">
                <div class="time-line-data">
                  ...
                  <span
                    v-if="
                      productInfo.info.preCommercialTime &&
                      productInfo.info.preCommercialTime !==
                        '0000-00-00 00:00:00'
                    "
                  >
                ...
                <div class="time-line-data">
                  ...
                  <span
                    v-if="
                      productInfo.info.commercialTime &&
                      productInfo.info.commercialTime !== '0000-00-00 00:00:00'
                    "
                  >
              ...
              <!-- <div class="time-line">
                <div class="time-point2" v-if="preCommercialTimeFlag">
                  <img
                    class="content-img"
                    src="@/assets/V2/yszImages/woStudent/huise40x40.png"
                    alt="试商用"
                  />
                  <span
                    >试商用
                ...
                <div class="time-point2" v-else >
                  <img
                    class="content-img"
                    src="@/assets/V2/yszImages/woStudent/time-point.png"
                    alt="试商用"
                  />
                  <span>
                    试商用
                ...
                <div class="time-point3" v-if="commercialTimeFlag">
                  <img
                    class="content-img"
                    src="@/assets/V2/yszImages/woStudent/huise40x40.png"
                    alt="正式商用"
          ...
          <div class="down-right-down">
              ...
              >
                ...
                >
                  <div class="classic-case" v-for="(item, i) in cases" :key="i">
                    ...
                    <div class="classic-case-name">{{ item.name }}</div>
                    <div class="blue-bg">{{ item.case }}</div>
                  </div>
                </el-carousel-item>
              </el-carousel>
            </div>
            ...
            <div class="down-right-down-content" v-else-if="cases.length === 1">
              <div class="classic-case">
                ...
                <div class="classic-case-name">{{ cases[0].name }}</div>
...
@import '@/assets/V2/styles/product-info-2b2c.scss';
</style>
